      ...
      return (
        <styles.Wrapper>
          <styles.TitleBox>
            ...
            <styles.SubTitle>하단의 소셜 플랫폼 계정으로 로그인을 진행하세요.</styles.SubTitle>
          </styles.TitleBox>
          <styles.ButtonBox>
      ...
      return (
        <styles.Wrapper>
          <styles.TitleBox>
            ...
            <styles.SubTitle>소셜 플랫폼 로그인 인증을 처리 중입니다.</styles.SubTitle>
          </styles.TitleBox>
        </styles.Wrapper>
      );
    case "Rejected":
      return (
        <styles.Wrapper>
          <styles.TitleBox>
            ...
            <styles.SubTitle>계정 인증을 실패했습니다. 재로그인 해주세요.</styles.SubTitle>
          </styles.TitleBox>
